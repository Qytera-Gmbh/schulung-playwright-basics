...
test.describe("even", () => {
    test.afterEach("I run only after even tests", ({}, testInfo) => { console.log(`After  /2 | ${testInfo.title}`); });
...
test.describe("odd", () => {    
    ...
    test.describe("divisible by 5", () => {
        test.beforeEach("I run only before tests divisibly by 5", ({}, testInfo) => { console.log(`Before /5 | ${testInfo.title}`); });
