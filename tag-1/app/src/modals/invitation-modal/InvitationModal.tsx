import { Divider, Modal, Progress, ScrollArea, Space, Text, Title } from "@mantine/core";
...
export default function InvitationModal(props: {
  ...
  return (
    ...
    >
      <ScrollArea h={"500px"} pe={"sm"} pl="md" pr="xl">
        <Space h="lg" />
        ...
        {props.data.additionalInformation.comments.length > 0 ? (
          <>
            ...
            <Text>{props.data.additionalInformation.comments}</Text>
          </>
        ) : null}
        <Divider my="md" />
      </ScrollArea>
